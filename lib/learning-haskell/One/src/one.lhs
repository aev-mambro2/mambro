...
A literate Haskell script
is when everything is considered a comment 
except or those lines marked to be a program.
Hugs reads these just fine. GHCI does not.
